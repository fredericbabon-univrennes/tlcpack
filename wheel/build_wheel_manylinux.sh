...
function usage() {
    ...
    echo
    echo -e "--cuda {none 10.2 11.1 11.3 11.6 11.7 11.8 12.1, 12.4}"
...
CUDA_OPTIONS=("none" "10.2" "11.1" "11.3" "11.6" "11.7" "11.8" "12.1" "12.4")
CUDA="none"
...
if ! in_array "${CUDA}" "${CUDA_OPTIONS[*]}" ; then
    ...
    echo
    echo 'CUDA can only be {"none", "10.2", "11.1", "11.3", "11.6" "11.7" "11.8" "12.1" "12.4"}'
    exit -1
fi
